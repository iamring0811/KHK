...
/* FMC SDRAM Bank configuration */   
  ...
  /* TMRD: 2 Clock cycles */
  FMC_SDRAMTimingInitStructure.FMC_LoadToActiveDelay    = 2;	//2;3;      
  /* TXSR: min=70ns (7x11.11ns) */                                    
  FMC_SDRAMTimingInitStructure.FMC_ExitSelfRefreshDelay = 7;    //7;9;
  /* TRAS: min=42ns (4x11.11ns) max=120k (ns) */                      
  FMC_SDRAMTimingInitStructure.FMC_SelfRefreshTime      = 4;    //4;6;
  /* TRC:  min=70 (7x11.11ns) */                                      
  FMC_SDRAMTimingInitStructure.FMC_RowCycleDelay        = 6;	//6;9;       
  /* TWR:  min=1+ 7ns (1+1x11.11ns) */                                
  FMC_SDRAMTimingInitStructure.FMC_WriteRecoveryTime    = 2;    //2;3;  
  /* TRP:  20ns => 2x11.11ns */                                       
  FMC_SDRAMTimingInitStructure.FMC_RPDelay              = 2;    //2;3;            
  /* TRCD: 20ns => 2x11.11ns */                                       
  FMC_SDRAMTimingInitStructure.FMC_RCDDelay             = 2;    //2;3;

/* FMC SDRAM control configuration */
  FMC_SDRAMInitStructure.FMC_Bank = FMC_Bank2_SDRAM;
  /* Column addressing: [9:0] */
  FMC_SDRAMInitStructure.FMC_ColumnBitsNumber = FMC_ColumnBits_Number_9b;	// org 8b
  /* Row addressing: [12:0] */
  FMC_SDRAMInitStructure.FMC_RowBitsNumber = FMC_RowBits_Number_12b;
  
  FMC_SDRAMInitStructure.FMC_SDMemoryDataWidth = SDRAM_MEMORY_WIDTH;
  FMC_SDRAMInitStructure.FMC_InternalBankNumber = FMC_InternalBank_Number_4;
  FMC_SDRAMInitStructure.FMC_CASLatency = FMC_CAS_Latency_3;		// org SDRAM_CAS_LATENCY; 
  FMC_SDRAMInitStructure.FMC_WriteProtection = FMC_Write_Protection_Disable;
  FMC_SDRAMInitStructure.FMC_SDClockPeriod = FMC_SDClock_Period_2;	
//  FMC_SDRAMInitStructure.FMC_SDClockPeriod = FMC_SDClock_Period_3;
  FMC_SDRAMInitStructure.FMC_ReadBurst = FMC_Read_Burst_Disable;	// org = SDRAM_READBURST;
