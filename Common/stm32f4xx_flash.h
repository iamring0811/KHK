...
/** @defgroup FLASH_Sectors
  * @{
  */
#define FLASH_Sector_0     ((uint16_t)0x0000) /*!< Sector Number 0  0x0800 0000 - 0x0800 3FFF  16KB */
#define FLASH_Sector_1     ((uint16_t)0x0008) /*!< Sector Number 1  0x0800 4000 - 0x0800 7FFF  16KB */
#define FLASH_Sector_2     ((uint16_t)0x0010) /*!< Sector Number 2  0x0800 8000 - 0x0800 BFFF  16KB */
#define FLASH_Sector_3     ((uint16_t)0x0018) /*!< Sector Number 3  0x0800 C000 - 0x0800 FFFF  16KB */
#define FLASH_Sector_4     ((uint16_t)0x0020) /*!< Sector Number 4  0x0801 0000 - 0x0801 FFFF  64KB */
#define FLASH_Sector_5     ((uint16_t)0x0028) /*!< Sector Number 5  0x0802 0000 - 0x0803 FFFF 128KB */
#define FLASH_Sector_6     ((uint16_t)0x0030) /*!< Sector Number 6  0x0804 0000 - 0x0805 FFFF 128KB */
#define FLASH_Sector_7     ((uint16_t)0x0038) /*!< Sector Number 7  0x0806 0000 - 0x0807 FFFF 128KB */	//Total 512KB
...
#define IS_FLASH_ADDRESS(ADDRESS) ((((ADDRESS) >= 0x08000000) && ((ADDRESS) < 0x0807FFFF)) ||\
                                   (((ADDRESS) >= 0x1FFFC000) && ((ADDRESS) < 0x1FFFC00F)))  
