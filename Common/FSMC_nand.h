...
#ifdef _FSMC_C_
/* Private variables ---------------------------------------------------------*/
uint8_t nandTxBuffer [NAND_PAGE_SIZE];
uint8_t nandRxBuffer [NAND_PAGE_SIZE];

#else
extern uint8_t nandTxBuffer [NAND_PAGE_SIZE];
extern uint8_t nandRxBuffer [NAND_PAGE_SIZE];
