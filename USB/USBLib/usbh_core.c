               ...
               USBH_Usr_cb_TypeDef *usr_cb)
{
  ...
  /* Hardware Init */
  //USB_OTG_BSP_Init(pdev);  ---> USB.C·Î ¿Å±è
	
  /* configure GPIO pin used for switching VBUS power */
  //USB_OTG_BSP_ConfigVBUS(0);  ---> USB.C·Î ¿Å±è
  ...
  /* Enable Interrupts */
  // USB_OTG_BSP_EnableInterrupt(pdev); --> USB.C ·Î ¿Å±è
}
  ...
  case HOST_ENUMERATION:     
    ...
    { 
      ...
      phost->usr_cb->EnumerationDone();
			...
			//UsbPrint("\r\n usbh_core.USBH_Process gState : HOST_ENUMERATION -->  HOST_USR_INPUT" );
    }
    break;
    
  case HOST_USR_INPUT:    
		//UsbPrint("\r\n USBH_Process HOST_USR_INPUT called");
    ...
    if ( phost->usr_cb->UserInput() == USBH_USR_RESP_OK)
    {
        ...
        == USBH_OK)
      {
        phost->gState  = HOST_CLASS_REQUEST;     
				//UsbPrint("\r\n usbh_core.USBH_Process gState : HOST_USR_INPUT -->  HOST_CLASS_REQUEST" );
      }     
    }   
    break;
    
  case HOST_CLASS_REQUEST:  
		//UsbPrint("\r\n USBH_Process HOST_CLASS_REQUEST called");
    ...
    status = phost->class_cb->Requests(pdev, phost);
     ...
     if(status == USBH_OK)
     {
       phost->gState  = HOST_CLASS;
			// UsbPrint("\r\n usbh_core.USBH_Process gState : HOST_CLASS_REQUEST -->  HOST_CLASS" );
     }     
     else
     {
			// UsbPrint("\r\n USBH_Process HOST_CLASS_REQUEST called and return error");
    ...
    break;    
  case HOST_CLASS:   
		//UsbPrint("\r\n USBH_Process HOST_CLASS called");
